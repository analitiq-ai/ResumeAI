"""
This file serves as repository of user information about the ideal job.
This info is then used to check if the particular job is a good match ot the user requirements.
For example, you may specify here salary requirements or that you want a part-time job.
USER_DESCR - general information about yourself.
USER_JOB_REQ - what kind of job you are looking for.
"""
...
Minority Status: A rare case of a fully armored Sith Lord in upper management
Occupation: Galactic Enforcer / Lord of the Sith / Unpaid Intern for Emperor Palpatine
Hobbies: Choking underperforming subordinates, dramatic cape swishing, brooding in the dark, building custom TIE Fighters, monologuing about destiny
